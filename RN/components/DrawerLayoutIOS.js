...
export default class DrawerLayout extends Base {
  ...
  static propTypes = {
    ...
    drawerPosition: PropTypes.oneOf(['left', 'right','bottom','top']).isRequired,
  ...
  constructor(props, context) {
    ...
    this._panResponderRelease = this._panResponderRelease.bind(this);

    this._panResponderMove = this._panResponderMove.bind(this);

    this._panResponderGrant = this._panResponderGrant.bind(this);
  ...
  baseRender() {
    ...
    let touchHandles = disabledTouch===true?{}:this._panResponder.panHandlers;
    return (
      <View style={{ overflow:'hidden',flex: 1, backgroundColor: 'transparent' }} {...touchHandles}>
