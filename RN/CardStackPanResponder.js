 ...
 */
const RESPOND_POSITION_MAX_HORIZONTAL = 50;
 ...
 *     +------------+
 */
class xzCardStackPanResponder extends NavigationAbstractPanResponder {
...
function createPanHandlers(
  ...
  const responder = new xzCardStackPanResponder(direction, props);
